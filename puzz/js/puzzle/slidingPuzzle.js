(function(angular) {
    ...
    module.directive('slidingPuzzle', function(slidingPuzzle) {
        return {
            restrict: 'EA',
            replace: true,
            template: '<div><table class="sliding-puzzle" ng-class="{\'puzzle-solved\': puzzle.isSolved()}">' +
                ...
                '</tr>' +
                '<tr><td></td></tr></table><div class="distancia" ng-show="puzzle.isSolved()"><span class="btn negro" ng-click="puzzle.finalizar()">Finalizar</span></div></div>',
            scope: {
                size: '@',
                src: '@',
                api: '='
